...
export class UserService {
  ...
  submitFileForApproval(file: any, userId: number) :Observable<any> {
    ...
    return this.http.post( 'http://52.3.246.6:8080/api/submitFileForApproval', formData, {headers:headers, params:queryParams});
  ...
  deleteUser(userId:number) :Observable<any> {
    let queryParams = new HttpParams();
    queryParams = queryParams.append("userId",userId);
    return this.http.delete(apiUrl + 'deleteuser',{headers,params:queryParams});
  ...
  updateUser(user: user) :Observable<any> {
    ...
    return this.http.put(apiUrl + 'updateuser',local_user,{headers});
